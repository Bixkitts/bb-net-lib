...
extern int sendDataUDP(const char *buffer, const uint16_t bufsize, const Client *remotehost);    // Sends UDP packets to a specified client
...
extern int connectToTCP(const Client *remotehost);
